/*
 * UART_with_rx_circular_buffer.c
 *
 * Created: 5/15/2017 10:40:06 PM
 * Author : Adam
 */ 
...
void UART_Init() {
	...
	rx_circ_buff_write_ptr = &buffer[0];
	rx_circ_buff_read_ptr = &buffer[0];
